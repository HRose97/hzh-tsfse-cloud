...
public class HzhUserExController {
    ...
    public ResultVO sendRegisterEmail(@RequestParam("email") String emailAddress) throws Exception {
         ResultVO emailCode = hzhUserExService.sendEmailCode(emailAddress,false);
